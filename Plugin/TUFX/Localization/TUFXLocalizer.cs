...
namespace TUFX
{
    ...
    public static class TUFXLocalizer
    {
        private static readonly Dictionary<string, string> EnglishToTag = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Profiler", "#LOC_TUFX_Nav_Profiler" },
            { "Performance Monitor", "#LOC_TUFX_Nav_Profiler" },
            ...
            { "Reset Peaks", "#LOC_TUFX_Btn_ResetPeaks" },
            { "Pause Probes", "#LOC_TUFX_Btn_PauseProfiler" },
            { "Resume Probes", "#LOC_TUFX_Btn_ResumeProfiler" },
            { "Stage", "#LOC_TUFX_Col_Stage" },
            { "Effect / Pass Name", "#LOC_TUFX_Col_EffectPass" },
            { "Avg Time", "#LOC_TUFX_Col_AvgTime" },
            { "Share %", "#LOC_TUFX_Col_Share" },
            { "Peak", "#LOC_TUFX_Col_Peak" },
            { "FPS", "#LOC_TUFX_Profiler_FPS" },
            { "Frame Latency", "#LOC_TUFX_Profiler_FrameTime" },
            { "TUFX Post-Process", "#LOC_TUFX_Profiler_TotalTUFX" },
            { "Active Passes", "#LOC_TUFX_Profiler_ActivePasses" },
            ...
            { "Temporal Anti-Aliasing (TAA)", "#LOC_TUFX_Effect_TAA" },
            { "Volumetric / Distance Fog", "#LOC_TUFX_Effect_Fog" },
            { "Fog", "#LOC_TUFX_Effect_Fog" },
            { "SMAA / FXAA Antialiasing", "#LOC_TUFX_Effect_SMAAFXAA" },
            { "Spatial Dithering", "#LOC_TUFX_Effect_Dithering" },
            { "Dithering", "#LOC_TUFX_Effect_Dithering" },
            { "Status", "#LOC_TUFX_Col_Status" },
            { "RUNNING", "#LOC_TUFX_Status_Running" },
            { "OFF", "#LOC_TUFX_Status_Off" },
